...
--依赖代码1，2
l DisplayLag=true;local I=Isaac I.AddCallback({},ModCallbacks.MC_POST_RENDER,function()if DisplayLag then local R,L,w,s=I.RenderText,I.GetTextWidth,I.GetScreenWidth()/2 s=string.format('%.2fs',Lag/30)R(s,w-L(s)/2,10,1,1,0,1)s=table.concat(GetBrokenKeys(),' ')R(s,w-L(s)/2,20,1,0,0,1)end end)
--.